...
![Очистка окружения](img/01.png)

## Задание 1. Настройка Service (ClusterIP и NodePort)

1. Создание Deployment с двумя контейнерами

![Создание Deployment](img/02.png)

2. Создание Service

![Создание Service](img/03.png)

3. Проверка доступности

![Проверка доступности](img/04.png)

4. Создание Service типа NodePort и проверка доступности

![Создание Service типа NodePort и проверка доступности](img/05.png)

## Задание 2. Настройка Ingress

1. Проверка Ingress-контроллера и создание  Deployment для frontend

![Проверка Ingress-контроллера и создание  Deployment для frontend](img/06.png)

2. Создание Deployment для backend

![Создание Deployment для backend](img/07.png)

3. Создание Service для frontend

![Создание Service для frontend](img/08.png)

4. Создание Service для backend и проверка всех сервисов

![Создание Service для backend](img/09.png)

5. Создание Ingress и проверка доступности

![Создание Ingress и проверка доступности](img/10.png)

6. Проверка доступности после создания Ingress

![Проверка доступности после создания Ingress](img/11.png)
![Проверка доступности после создания Ingress](img/12.png)
